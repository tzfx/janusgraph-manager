...
var JanusGraphManager = (function () {
    function JanusGraphManager(client, graphName, useConfiguredGraphFactory) {
        if (graphName === void 0) { graphName = 'graph'; }
        if (useConfiguredGraphFactory === void 0) { useConfiguredGraphFactory = false; }
        this.client = client;
        this.graphName = graphName;
        this.useConfiguredGraphFactory = useConfiguredGraphFactory;
        this.state = "NEW";
        this.OPEN_MGMT = "mgmt = " + this.graphName + ".openManagement();0;";
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        if (!this.useConfiguredGraphFactory) return [3, 2];
                        return [4, this.client.submit(this.graphName + " = ConfiguredGraphFactory.open('" + this.graphName + ")")];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4, this.client.submit(this.OPEN_MGMT)];
                    case 3:
                        _a.sent();
...
var GraphIndexBuilder = (function () {
    ...
    GraphIndexBuilder.prototype.build = function () {
        ...
        return output.concat(this._type === "Composite"
            ? ".buildCompositeIndex();"
